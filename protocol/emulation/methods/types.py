...
if TYPE_CHECKING:
    ...
    from emulation.types import DevicePosture
    from emulation.types import DisabledImageType
    from emulation.types import DisplayFeature
    from emulation.types import MediaFeature
    from emulation.types import PressureMetadata
    from emulation.types import PressureSource
    from emulation.types import PressureState
    from emulation.types import SafeAreaInsets
    from emulation.types import ScreenId
    from emulation.types import ScreenInfo
    from emulation.types import ScreenOrientation
    from emulation.types import SensorMetadata
    from emulation.types import SensorReading
    from emulation.types import SensorType
    from emulation.types import UserAgentMetadata
    from emulation.types import VirtualTimePolicy
    from emulation.types import WorkAreaInsets
