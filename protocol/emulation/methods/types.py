...
if TYPE_CHECKING:
    from protocol.dom.types import RGBA
    from protocol.emulation.types import DevicePosture
    from protocol.emulation.types import DisabledImageType
    from protocol.emulation.types import DisplayFeature
    from protocol.emulation.types import MediaFeature
    from protocol.emulation.types import PressureMetadata
    from protocol.emulation.types import PressureSource
    from protocol.emulation.types import PressureState
    from protocol.emulation.types import SafeAreaInsets
    from protocol.emulation.types import ScreenId
    from protocol.emulation.types import ScreenInfo
    from protocol.emulation.types import ScreenOrientation
    from protocol.emulation.types import SensorMetadata
    from protocol.emulation.types import SensorReading
    from protocol.emulation.types import SensorType
    from protocol.emulation.types import UserAgentMetadata
    from protocol.emulation.types import VirtualTimePolicy
    from protocol.emulation.types import WorkAreaInsets
