...
if TYPE_CHECKING:
    ...
    from protocol.dom.types import BoxModel
    from protocol.dom.types import CSSComputedStyleProperty
    from protocol.dom.types import DetachedElementInfo
    from protocol.dom.types import LogicalAxes
    from protocol.dom.types import Node
    from protocol.dom.types import NodeId
    from protocol.dom.types import PhysicalAxes
