...
if TYPE_CHECKING:
    from protocol.debugger.types import SearchMatch
    from protocol.dom.types import Rect
    from protocol.io.types import StreamHandle
    from protocol.network.types import LoaderId
    from protocol.page.types import AdScriptAncestry
    from protocol.page.types import AppManifestError
    from protocol.page.types import AppManifestParsedProperties
    from protocol.page.types import CompilationCacheParams
    from protocol.page.types import FontFamilies
    from protocol.page.types import FontSizes
    from protocol.page.types import FrameId
    from protocol.page.types import FrameResourceTree
    from protocol.page.types import FrameTree
    from protocol.page.types import InstallabilityError
    from protocol.page.types import LayoutViewport
    from protocol.page.types import NavigationEntry
    from protocol.page.types import OriginTrial
    from protocol.page.types import PermissionsPolicyFeatureState
    from protocol.page.types import ReferrerPolicy
    from protocol.page.types import ScriptFontFamilies
    from protocol.page.types import ScriptIdentifier
    from protocol.page.types import TransitionType
    from protocol.page.types import Viewport
    from protocol.page.types import VisualViewport
    from protocol.page.types import WebAppManifest
    from protocol.runtime.types import ExecutionContextId
