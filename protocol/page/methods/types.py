...
if TYPE_CHECKING:
    ...
    from page.types import AdScriptAncestry
    from page.types import AppManifestError
    from page.types import AppManifestParsedProperties
    from page.types import CompilationCacheParams
    from page.types import FontFamilies
    from page.types import FontSizes
    from page.types import FrameId
    from page.types import FrameResourceTree
    from page.types import FrameTree
    from page.types import InstallabilityError
    from page.types import LayoutViewport
    from page.types import NavigationEntry
    from page.types import OriginTrial
    from page.types import PermissionsPolicyFeatureState
    from page.types import ReferrerPolicy
    from page.types import ScriptFontFamilies
    from page.types import ScriptIdentifier
    from page.types import TransitionType
    from page.types import Viewport
    from page.types import VisualViewport
    from page.types import WebAppManifest
