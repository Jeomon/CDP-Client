...
if TYPE_CHECKING:
    from css.types import CSSAnimationStyle
    from css.types import CSSAtRule
    from css.types import CSSComputedStyleProperty
    from css.types import CSSContainerQuery
    from css.types import CSSFunctionRule
    from css.types import CSSKeyframesRule
    from css.types import CSSLayerData
    from css.types import CSSMedia
    from css.types import CSSPositionTryRule
    from css.types import CSSProperty
    from css.types import CSSPropertyRegistration
    from css.types import CSSPropertyRule
    from css.types import CSSRule
    from css.types import CSSScope
    from css.types import CSSStyle
    from css.types import CSSSupports
    from css.types import ComputedStyleExtraFields
    from css.types import InheritedAnimatedStyleEntry
    from css.types import InheritedPseudoElementMatches
    from css.types import InheritedStyleEntry
    from css.types import PlatformFontUsage
    from css.types import PseudoElementMatches
    from css.types import RuleMatch
    from css.types import RuleUsage
    from css.types import SelectorList
    from css.types import SourceRange
    from css.types import StyleDeclarationEdit
    from css.types import StyleSheetId
    from css.types import Value
