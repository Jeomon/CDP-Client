...
if TYPE_CHECKING:
    from protocol.css.types import CSSAnimationStyle
    from protocol.css.types import CSSAtRule
    from protocol.css.types import CSSComputedStyleProperty
    from protocol.css.types import CSSContainerQuery
    from protocol.css.types import CSSFunctionRule
    from protocol.css.types import CSSKeyframesRule
    from protocol.css.types import CSSLayerData
    from protocol.css.types import CSSMedia
    from protocol.css.types import CSSPositionTryRule
    from protocol.css.types import CSSProperty
    from protocol.css.types import CSSPropertyRegistration
    from protocol.css.types import CSSPropertyRule
    from protocol.css.types import CSSRule
    from protocol.css.types import CSSScope
    from protocol.css.types import CSSStyle
    from protocol.css.types import CSSSupports
    from protocol.css.types import ComputedStyleExtraFields
    from protocol.css.types import InheritedAnimatedStyleEntry
    from protocol.css.types import InheritedPseudoElementMatches
    from protocol.css.types import InheritedStyleEntry
    from protocol.css.types import PlatformFontUsage
    from protocol.css.types import PseudoElementMatches
    from protocol.css.types import RuleMatch
    from protocol.css.types import RuleUsage
    from protocol.css.types import SelectorList
    from protocol.css.types import SourceRange
    from protocol.css.types import StyleDeclarationEdit
    from protocol.css.types import StyleSheetId
    from protocol.css.types import Value
    from protocol.dom.types import NodeId
    from protocol.dom.types import PseudoType
