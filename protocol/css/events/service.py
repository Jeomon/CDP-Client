...
class CSSEvents:
    ...
    def on_fonts_updated(self, callback: Callable[[fontsUpdatedEvent,Optional[str]], None]=None) -> None:
        ...
        self.client.on('fontsUpdated', callback)
