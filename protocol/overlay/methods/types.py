...
if TYPE_CHECKING:
    ...
    from overlay.types import ColorFormat
    from overlay.types import ContainerQueryHighlightConfig
    from overlay.types import FlexNodeHighlightConfig
    from overlay.types import GridNodeHighlightConfig
    from overlay.types import HighlightConfig
    from overlay.types import HingeConfig
    from overlay.types import InspectMode
    from overlay.types import IsolatedElementHighlightConfig
    from overlay.types import ScrollSnapHighlightConfig
    from overlay.types import SourceOrderConfig
    from overlay.types import WindowControlsOverlayConfig
