...
if TYPE_CHECKING:
    ...
    from protocol.dom.types import Quad
    from protocol.dom.types import RGBA
    from protocol.overlay.types import ColorFormat
    from protocol.overlay.types import ContainerQueryHighlightConfig
    from protocol.overlay.types import FlexNodeHighlightConfig
    from protocol.overlay.types import GridNodeHighlightConfig
    from protocol.overlay.types import HighlightConfig
    from protocol.overlay.types import HingeConfig
    from protocol.overlay.types import InspectMode
    from protocol.overlay.types import IsolatedElementHighlightConfig
    from protocol.overlay.types import ScrollSnapHighlightConfig
    from protocol.overlay.types import SourceOrderConfig
    from protocol.overlay.types import WindowControlsOverlayConfig
