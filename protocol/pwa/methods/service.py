...
from protocol.pwa.methods.types import *

class PWAMethods:
    def __init__(self, methods:CDPMethods):
        self.methods = methods

    async def get_os_app_state(self, params: Optional[getOsAppStateParameters]=None) -> getOsAppStateReturns:
        """Returns the following OS state for the given manifest id."""
        return await self.methods.send(method="PWA.getOsAppState", params=params)

    async def install(self, params: Optional[installParameters]=None) -> Dict[str, Any]:
        ...
        return await self.methods.send(method="PWA.install", params=params)

    async def uninstall(self, params: Optional[uninstallParameters]=None) -> Dict[str, Any]:
        """Uninstalls the given manifest_id and closes any opened app windows."""
        return await self.methods.send(method="PWA.uninstall", params=params)

    async def launch(self, params: Optional[launchParameters]=None) -> launchReturns:
        ...
        return await self.methods.send(method="PWA.launch", params=params)

    async def launch_files_in_app(self, params: Optional[launchFilesInAppParameters]=None) -> launchFilesInAppReturns:
        ...
        return await self.methods.send(method="PWA.launchFilesInApp", params=params)

    async def open_current_page_in_app(self, params: Optional[openCurrentPageInAppParameters]=None) -> Dict[str, Any]:
        ...
        return await self.methods.send(method="PWA.openCurrentPageInApp", params=params)

    async def change_app_user_settings(self, params: Optional[changeAppUserSettingsParameters]=None) -> Dict[str, Any]:
        ...
        return await self.methods.send(method="PWA.changeAppUserSettings", params=params)
