...
if TYPE_CHECKING:
    ...
    from protocol.debugger.types import DebugSymbols
    from protocol.debugger.types import ResolvedBreakpoint
    from protocol.debugger.types import ScriptLanguage
