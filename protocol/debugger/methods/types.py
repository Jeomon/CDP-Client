...
if TYPE_CHECKING:
    from protocol.debugger.types import BreakLocation
    from protocol.debugger.types import BreakpointId
    from protocol.debugger.types import CallFrame
    from protocol.debugger.types import CallFrameId
    from protocol.debugger.types import Location
    from protocol.debugger.types import LocationRange
    from protocol.debugger.types import ScriptPosition
    from protocol.debugger.types import SearchMatch
    from protocol.debugger.types import WasmDisassemblyChunk
    from protocol.runtime.types import CallArgument
    from protocol.runtime.types import ExceptionDetails
    from protocol.runtime.types import RemoteObject
    from protocol.runtime.types import RemoteObjectId
    from protocol.runtime.types import ScriptId
    from protocol.runtime.types import StackTrace
    from protocol.runtime.types import StackTraceId
    from protocol.runtime.types import TimeDelta
    from protocol.runtime.types import UniqueDebuggerId
