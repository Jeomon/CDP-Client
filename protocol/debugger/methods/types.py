...
if TYPE_CHECKING:
    from debugger.types import BreakLocation
    from debugger.types import BreakpointId
    from debugger.types import CallFrame
    from debugger.types import CallFrameId
    from debugger.types import Location
    from debugger.types import LocationRange
    from debugger.types import ScriptPosition
    from debugger.types import SearchMatch
    from debugger.types import WasmDisassemblyChunk
