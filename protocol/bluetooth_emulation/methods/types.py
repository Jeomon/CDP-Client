...
if TYPE_CHECKING:
    from protocol.bluetooth_emulation.types import CentralState
    from protocol.bluetooth_emulation.types import CharacteristicOperationType
    from protocol.bluetooth_emulation.types import CharacteristicProperties
    from protocol.bluetooth_emulation.types import DescriptorOperationType
    from protocol.bluetooth_emulation.types import GATTOperationType
    from protocol.bluetooth_emulation.types import ManufacturerData
    from protocol.bluetooth_emulation.types import ScanEntry
