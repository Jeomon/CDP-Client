...
if TYPE_CHECKING:
    from bluetooth_emulation.types import CentralState
    from bluetooth_emulation.types import CharacteristicOperationType
    from bluetooth_emulation.types import CharacteristicProperties
    from bluetooth_emulation.types import DescriptorOperationType
    from bluetooth_emulation.types import GATTOperationType
    from bluetooth_emulation.types import ManufacturerData
    from bluetooth_emulation.types import ScanEntry
