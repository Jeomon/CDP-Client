...
if TYPE_CHECKING:
    from protocol.browser.types import Bounds
    from protocol.browser.types import BrowserCommandId
    from protocol.browser.types import BrowserContextID
    from protocol.browser.types import Histogram
    from protocol.browser.types import PermissionDescriptor
    from protocol.browser.types import PermissionSetting
    from protocol.browser.types import PrivacySandboxAPI
    from protocol.browser.types import WindowID
