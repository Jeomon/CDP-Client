...
if TYPE_CHECKING:
    from browser.types import Bounds
    from browser.types import BrowserCommandId
    from browser.types import BrowserContextID
    from browser.types import Histogram
    from browser.types import PermissionDescriptor
    from browser.types import PermissionSetting
    from browser.types import PrivacySandboxAPI
    from browser.types import WindowID
