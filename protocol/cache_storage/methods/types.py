...
if TYPE_CHECKING:
    from cache_storage.types import Cache
    from cache_storage.types import CacheId
    from cache_storage.types import CachedResponse
    from cache_storage.types import DataEntry
    from cache_storage.types import Header
