...
if TYPE_CHECKING:
    from protocol.cache_storage.types import Cache
    from protocol.cache_storage.types import CacheId
    from protocol.cache_storage.types import CachedResponse
    from protocol.cache_storage.types import DataEntry
    from protocol.cache_storage.types import Header
