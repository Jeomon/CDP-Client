...
if TYPE_CHECKING:
    ...
    from protocol.input.types import GestureSourceType
    from protocol.input.types import MouseButton
    from protocol.input.types import TimeSinceEpoch
    from protocol.input.types import TouchPoint
