...
if TYPE_CHECKING:
    ...
    from storage.types import RelatedWebsiteSet
    from storage.types import SerializedStorageKey
    from storage.types import SharedStorageEntry
    from storage.types import SharedStorageMetadata
    from storage.types import StorageBucket
    from storage.types import TrustTokens
    from storage.types import UsageForType
