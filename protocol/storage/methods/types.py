...
if TYPE_CHECKING:
    from protocol.browser.types import BrowserContextID
    ...
    from protocol.storage.types import RelatedWebsiteSet
    from protocol.storage.types import SerializedStorageKey
    from protocol.storage.types import SharedStorageEntry
    from protocol.storage.types import SharedStorageMetadata
    from protocol.storage.types import StorageBucket
    from protocol.storage.types import TrustTokens
    from protocol.storage.types import UsageForType
