...
if TYPE_CHECKING:
    ...
    from layer_tree.types import LayerId
    from layer_tree.types import PaintProfile
    from layer_tree.types import PictureTile
    from layer_tree.types import SnapshotId
