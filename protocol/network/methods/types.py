...
if TYPE_CHECKING:
    ...
    from protocol.network.types import BlockPattern
    from protocol.network.types import ConnectionType
    from protocol.network.types import ContentEncoding
    from protocol.network.types import Cookie
    from protocol.network.types import CookieParam
    from protocol.network.types import CookiePartitionKey
    from protocol.network.types import CookiePriority
    from protocol.network.types import CookieSameSite
    from protocol.network.types import CookieSourceScheme
    from protocol.network.types import Headers
    from protocol.network.types import InterceptionId
    from protocol.network.types import LoadNetworkResourceOptions
    from protocol.network.types import LoadNetworkResourcePageResult
    from protocol.network.types import NetworkConditions
    from protocol.network.types import RequestId
    from protocol.network.types import SecurityIsolationStatus
