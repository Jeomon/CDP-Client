...
if TYPE_CHECKING:
    from tracing.types import MemoryDumpLevelOfDetail
    from tracing.types import StreamCompression
    from tracing.types import StreamFormat
    from tracing.types import TraceConfig
    from tracing.types import TracingBackend
