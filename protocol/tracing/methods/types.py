...
if TYPE_CHECKING:
    from protocol.tracing.types import MemoryDumpLevelOfDetail
    from protocol.tracing.types import StreamCompression
    from protocol.tracing.types import StreamFormat
    from protocol.tracing.types import TraceConfig
    from protocol.tracing.types import TracingBackend
